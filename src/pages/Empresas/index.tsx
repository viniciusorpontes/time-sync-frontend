...
const EmpresaPage = () => {
            ...
            <React.Fragment>
                <div className="my-2">
                    ...
                    <Button label="Excluir" icon="pi pi-trash" severity="danger" onClick={confirmDeleteSelected}
                            disabled={!selecionados || !(selecionados as any).length}/>
                </div>
            </React.Fragment>
        );
    };
    ...
    const actionBodyTemplate = (rowData: Empresa) => {
        return (
            <div className='botoes'>
                <Button icon="pi pi-pencil" rounded severity="success" style={{margin: "0 10px"}}
                        onClick={() => editEmpresa(rowData)}/>
                <Button icon="pi pi-trash" rounded severity="warning" className="botao-redondo"
    ...
    const actionBodyTemplateEmpresaUsuario = (rowData: EmpresaUsuario) => {
        return (
            <>
                <div className='botoes'>
                    <Button icon="pi pi-pencil" rounded severity="success" style={{margin: "0 10px"}}
                            onClick={() => editUsuarioEmpresa(rowData)}/>
                    <Button icon="pi pi-trash" rounded severity="warning" className="botao-redondo"
                            onClick={() => confirmDeleteUsuarioEmpresa(rowData)}/>
                </div>
            </>
        );
    };
    ...
    const isDsuarioConfirmadoBodyTemplate = (rowData: EmpresaUsuario) => {
        return <i className={classNames('pi', {
            'text-green-500 pi-check-circle': rowData.confirmado,
            'text-red-500 pi-times-circle': !rowData.confirmado
        })}></i>;
    };

    const isGestorBodyTemplate = (rowData: EmpresaUsuario) => {
        return <i className={classNames('pi', {
            'text-green-500 pi-check-circle': rowData.gestor,
            'text-red-500 pi-times-circle': !rowData.gestor
        })}></i>;
    };
    ...
    return (
        <div style={{paddingTop: "14px"}}>
            ...
            <Dialog visible={dialog} style={{width: '1000px'}} header="Detalhes da Empresa" modal className="p-fluid"
                    onHide={hideDialog}>
                    ...
                    <TabPanel header="Dados da Empresa">
                        ...
                        <div className="field" style={{marginBottom: "10px"}}>
                            ...
                            <InputText
                                ...
                                required
                                className={classNames({
                                    'p-invalid': submitted && !empresa.endereco
                                })}
                            />
                            {submitted && !empresa.endereco &&
                        ...
                        <div className="field" style={{marginBottom: "10px"}}>
                            ...
                            <InputText
                                ...
                                required
                                className={classNames({
                                    'p-invalid': submitted && !empresa.telefone
                                })}
                            />
                            {submitted && !empresa.telefone &&
                                <small className="p-invalid">Telefone é obrigatório.</small>}
                        </div>


                        <div className='botoes'>
                            <Button style={{width: '200px'}} className="botao" label="Salvar" severity="success"
                                    onClick={saveEmpresa}/>
                            <Button style={{width: '200px'}} className="botao" label="Cancelar" severity="danger"
                                    onClick={hideDialog}/>
                        </div>
                    </TabPanel>
                    <TabPanel header="Produtivos">
                        <div className='formulario-empresa-usuario'>
                            ...
                            <div className='checkbox'>
                                <Checkbox inputId="gestor" value="Gestor" onChange={onGestorChange}
                                          checked={usuarioEmpresa.gestor}/>
                                <label htmlFor="gestor" style={{paddingLeft: "2%"}}>Gestor</label>
                            </div>
                            {
                                !editandoUsuarioEmpresa &&
                                <Button style={{width: '35%', height: '50px'}} severity="info" label="Enviar"
                                        onClick={convidarUsuario}/>
                            }
                            {
                                editandoUsuarioEmpresa &&
                                <div style={{display: "flex", width: "35%"}}>
                                    <Button style={{width: '50%', marginLeft: '1%', height: '50px'}} severity="success"
                                            label="Salvar" onClick={salvarAlteracaoUsuario}/>
                                    <Button style={{width: '50%', marginLeft: '1%', height: '50px'}} severity="danger"
                                            label="Cancelar" onClick={cancelarAlteracao}/>
                                </div>
                            }
                        </div>
                        <br></br>
                        ...
                        >
                            ...
                            <Column field="confirmado" header="Confirmado" dataType="boolean"
                                    bodyClassName="text-center" style={{minWidth: '8rem'}}
                                    body={isDsuarioConfirmadoBodyTemplate}/>
                            <Column field="gestor" header="Gestor" dataType="boolean" bodyClassName="text-center"
                                    style={{minWidth: '8rem'}} body={isGestorBodyTemplate}/>
            ...
            <Dialog visible={deleteDialog} style={{width: '450px'}} header="Confirmar" modal footer={deleteDialogFooter}
            ...
            <Dialog visible={deleteUsuarioEmpresaDialog} style={{width: '450px'}} header="Confirmar" modal
                    footer={deleteUsuarioEmpresaDialogFooter} onHide={hideDeleteUsuarioEmpresaDialog}>
                <div className="flex align-items-center justify-content-center">
                    <i className="pi pi-exclamation-triangle mr-3" style={{fontSize: '2rem'}}/>
                    {empresa && (
                        <span>
            ...
            <Dialog visible={multiDeleteDialog} style={{width: '450px'}} header="Confirm" modal
                    footer={multiDeleteDialogFooter} onHide={hideDeleteEmpresasDialog}>
                <div className="flex align-items-center justify-content-center">
                    <i className="pi pi-exclamation-triangle mr-3" style={{fontSize: '2rem'}}/>
